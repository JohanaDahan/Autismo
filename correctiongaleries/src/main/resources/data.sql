...
INSERT INTO Compte(DTYPE,id, nom, prenom, adresse, ville, numtel, email,mdp) VALUES 
    ('Medecin','WassLaMenace', 'Aityoucef', 'Wassim','24 rue de la Tolosane','81100 Castres','0782350075','wass.aityoucef@gmail.com','pipicacaproutmdr'),
    ('Medecin','RemiBastide', 'Bastide', 'Remi','2 rue de la Paix','81000 Albi','0606060606','remibastide@gmail.com','remibastide'),
    ('Patient','narcolin', 'Gay', 'Colin','11 place de la République','81100 Castres','0783734322','colin.gay25@gmail.com','jesuisGAYcolin'),
